...
void InitSysCtrl(void)
{
   ...
   InitPll(DSP28_PLLCR,DSP28_DIVSEL);		// x35-> 150Mhz, x32 -> 100Mhz.
...
// HISPCP/LOSPCP prescale register settings, normally it will be set to default values
   SysCtrlRegs.HISPCP.all = DSP28_HISPCP;
   SysCtrlRegs.LOSPCP.all = DSP28_LOSPCP;	// Lowspeedclock= SYSCLKOUT/4 = 150/4=37.5MHZ;
